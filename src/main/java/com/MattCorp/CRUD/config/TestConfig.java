package com.MattCorp.CRUD.config;
...
import com.MattCorp.CRUD.entities.Payment;
import com.MattCorp.CRUD.entities.Product;
import com.MattCorp.CRUD.entities.User;
import com.MattCorp.CRUD.entities.enums.OrderStatus;
import com.MattCorp.CRUD.repositories.CategoryRepository;
import com.MattCorp.CRUD.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategories().add(cat2); /* relacionando os produtos entre categorias para salvar no banco de forma relacional */
		...
		userRepository.saveAll(Arrays.asList(u1,u2)); /* salva uma lista de objetos */
